...
## Project Structure
    ...
    ├── testapiautoteammem_106366  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_106366`
...
2. Clone this repo and `cd testapiautoteammem_106366`
